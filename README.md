...
defined, the filtering is actually conducted using `auk_filter()`.
    ...
    ebd
    #> Input 
    #>   EBD: /private/var/folders/wf/957fnnnd127fsdkxc1dtmc2m0000gp/T/RtmpJYh6zC/temp_libpath1e506dc3e0dc/auk/extdata/ebd-sample.txt 
    #> 
    #> Output 
...
eBird Basic Dataset files can be read with `read_ebd()`:
    ...
    #>  $ taxonomic_order          : num [1:398] 21233 21233 21181 21181 21233 ...
