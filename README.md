...
auk_clean(f, f_out)
#> [1] "/var/folders/mg/qh40qmqd7376xn8qxd6hm5lwjyy0h2/T//RtmpuMBwgt/file3a7f2efc51d1"
...
system.file("extdata/ebd-sample.txt", package = "auk") %>% 
  read_ebd() %>% 
  str()
#> Classes 'tbl_df', 'tbl' and 'data.frame':    493 obs. of  49 variables:
...
`auk` benefited significantly from the [rOpenSci](https://ropensci.org/) review process, including helpful suggestions from [Auriel Fournier](https://github.com/aurielfournier) and [Edmund Hart](https://github.com/emhart).
