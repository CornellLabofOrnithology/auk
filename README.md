...
drops these erroneous records and removes the blank column.
    ...
    auk_clean(f, f_out)
    #> [1] "/var/folders/mg/qh40qmqd7376xn8qxd6hm5lwjyy0h2/T//Rtmp2t8nD1/fileaa767d02ef59"
...
eBird Basic Dataset files can be read with `read_ebd()`:
    ...
    #>  $ locality                    : chr  "07_020_AN_CafetalPedro_trad_P06" "07_020_LaConcordia_SanFrancsco_Magallanes_P01" "07_020_LaConcordia_SanFrancsco_Crucero_P10" "07_020_LaConcordia_SanFrancsco_Bosque_P02" ...
    ...
    #>  $ trip_comments               : chr  "Pedro Pablo Vzquez" "Miguel Mndez Lpez" "Miguel Mndez Lpez" "Miguel Mndez Lpez" ...
